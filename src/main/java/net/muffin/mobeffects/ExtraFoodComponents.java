...
public class ExtraFoodComponents {
    ...
    public static final FoodComponent COD = create(Items.COD, new FoodComponent.Builder().hunger(5).saturationModifier(0.6f).build());
    public static final FoodComponent SALMON = create(Items.SALMON, new FoodComponent.Builder().hunger(5).saturationModifier(0.6f).build());
